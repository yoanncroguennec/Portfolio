...
// IMGS
// import Personnage2D from "../../../../utils/assets/imgs/personnage2D/personnage.png"
...
export default function LanguagesSoftwares() {
  ...
  //////////////////// STYLES ////////////////////
  const RootLanguagesSoftwares = styled(Box)(({ theme }) => ({
    // background: "red",
    // height: "100vh",
    // width: "20vw",
    // margin: "0 auto",
  ...
  //////////////////// RETURN ////////////////////
  return (
    <RootLanguagesSoftwares id='technologies'>
      <Image
